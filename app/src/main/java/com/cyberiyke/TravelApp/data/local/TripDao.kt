...
interface TripDao {
    ...
    suspend fun insertArticle(article: List<com.cyberiyke.TravelApp.data.local.TripEntity>)

    @Query("SELECT * FROM favourite_article ORDER BY articleDateTime DESC")
    fun getAllArticles(): LiveData<List<com.cyberiyke.TravelApp.data.local.TripEntity>>
    ...
    fun getFavoriteArticles():LiveData<List<com.cyberiyke.TravelApp.data.local.TripEntity>>
